...
def make_random_rhythmic_figure(duration_in_quarters=4, shuffle=True, smallest_duration='sixteenths'):
    remaining_duration = duration_in_quarters
    rhythm = []
    if smallest_duration == 'sixteenths':
        tick_duration = .25
        multiply_quarter_by = 4
    elif smallest_duration == 'eighths':
        tick_duration = .5
        multiply_quarter_by = 2
    elif smallest_duration == 'quarters':
        tick_duration = 1.0
        multiply_quarter_by = 1

    while remaining_duration:
        duration_options = np.linspace(tick_duration, remaining_duration, remaining_duration * multiply_quarter_by)
